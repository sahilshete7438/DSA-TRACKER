<template>
  <div class="sorting-page">
    <header>
      <h1>DSA Tracker - Sorting Techniques</h1>
      <nav>
    ...
    <div class="search-container">
     <a href="https://www.codechef.com/practice/course/sorting/SORTING/problems/RACE400M" target="_blank">
    <button class="mcq-button">MCQ</button>
   </a>
      <input
        type="text"
        v-model="searchQuery"
        placeholder="Search Sorting Techniques..."
        class="search-bar"
      />
...
export default {
  data() {
    return {
      searchQuery: "",
      topics: [
        { name: "Bubble Sort", completed: false, videoLink: "https://youtu.be/CkXjf6_8DLU?si=usNha1QnMkGvHPV2", articleLink: "https://www.geeksforgeeks.org/bubble-sort-algorithm/" },
        { name: "Selection Sort", completed: false, videoLink: "https://youtu.be/slXyQKww0-E?si=sjTOMXUddPErxkoh", articleLink: "https://www.geeksforgeeks.org/selection-sort-algorithm-2/" },
        { name: "Insertion Sort", completed: false, videoLink: "https://youtu.be/XBfH1Qy1JGY?si=c_j8u4VH0EJCj2zg", articleLink: "https://youtu.be/XBfH1Qy1JGY?si=c_j8u4VH0EJCj2zg" },
        { name: "Merge Sort", completed: false, videoLink: "https://youtu.be/ytK4Biw-CW4?si=juW8x6BxLteNRD2p", articleLink: "https://www.geeksforgeeks.org/merge-sort/" },
        { name: "Quick Sort", completed: false, videoLink: "https://youtu.be/SN4x87ZdhGg?si=YH3vj36wR4i2jSob", articleLink: "https://www.geeksforgeeks.org/quick-sort-algorithm/" },
      ],
    };
  },
  computed: {
